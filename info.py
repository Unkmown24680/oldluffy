...
URL = "https://{share-me-bro.koyeb.app}/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://{share-me-bro.koyeb.app}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://{share-me-bro.koyeb.app}/".format(FQDN)
else:
    URL = "http://{share-me-bro.koyeb.app}/".format(FQDN)
