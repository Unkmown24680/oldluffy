...
URL = "https://{luffy-files-share-and-support-me.koyeb.app}/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://{luffy-files-share-and-support-me.koyeb.app}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://{luffy-files-share-and-support-me.koyeb.app}/".format(FQDN)
else:
    URL = "http://{luffy-files-share-and-support-me.koyeb.app}/".format(FQDN)
